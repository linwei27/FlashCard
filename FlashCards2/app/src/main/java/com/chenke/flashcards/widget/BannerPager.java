package com.chenke.flashcards.widget;
...
public class BannerPager extends RelativeLayout implements View.OnClickListener {
    ...
    private ViewPager vp_banner;  //翻页视图对象
    private RadioGroup rg_indicator;  //单选组对象
    private List<ImageView> mViewList = new ArrayList<>();  //图像视图队列
    private int mInterval = 2000;  //轮播时间间
