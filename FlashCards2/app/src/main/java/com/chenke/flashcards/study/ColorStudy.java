...
public class ColorStudy extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //查看本地是否有用户的进度信息
//        SharedPreferences sp = this.getSharedPreferences("record_color", Context.MODE_PRIVATE);
//        rate = sp.getInt("rate", -1); //若无数据为-1
    ...
    private void next() {
        ...
        i++;
        img_color.setBackgroundColor(colorValue[i-1]);
        Log.e("打印：","下一个");
    }
    ...
    public class GetRecordTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (Integer.parseInt(s) != -1) {
                img_color.setBackgroundColor(colorValue[Integer.parseInt(s)-1]);
