...
import static com.chenke.flashcards.util.Utils.getFontHeight;
...
public class ProgressCircleChart extends View {
    ...
    //中间label的间距
    private float labelSpace = Utils.dip2px(getContext(),4);
    ...
    private void init(AttributeSet attrs){
        ...
        colorRing = typedArray.getColor(R.styleable.ProgressCircleChart_colorRing, Color.rgb(30,144,255));
        ringWidth = (int) typedArray.getDimension(R.styleable.ProgressCircleChart_ringWidth,Utils.dip2px(getContext(),12));
        colorRingDef = typedArray.getColor(R.styleable.ProgressCircleChart_colorRingDef,Color.RED);
        ...
        labelSpace = typedArray.getDimension(R.styleable.ProgressCircleChart_labelSpace,Utils.dip2px(getContext(),4));
        typedArray.recycle();
        init();
    }
    ...
    private void initAfterMeasure() {
        ...
        for (int i = 0; i < labelList.size(); i++) {
            ...
            float fontHeight = getFontHeight(paintText);
    ...
    private void drawCenterText(Canvas canvas) {
        ...
        for (int i = 0; i < labelList.size(); i++) {
            ...
            float textHeight = Utils.getFontHeight(paintText);
