...
//        vp_content.setCurrentItem(0);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (drelen < 0) {
                        ...
                        //时间结束，弹出对话框，要求交卷
                        //弹出对话框
                        AlertDialog.Builder builder = new AlertDialog.Builder(ShapeExercise.this);
                        builder.setTitle("提示");
                        ...
                        builder.setNegativeButton("否", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(ShapeExercise.this,"时间已用完，不能提交答案。",Toast.LENGTH_LONG).show();
                            }
                        });
                        ...
                        builder.setPositiveButton("是", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                            //跳转到练习报告页面
                            Intent intent = new Intent(ShapeExercise.this, NumberReport.class);
                            //获取用户的答案，和正确答案，传递过去判断
                            intent.putExtra("TAG","Shape");
                            // 正确的答案，对象
                            getAnswer();  //执行获取答案列表
                            Bundle bundle = new Bundle();
                            bundle.putStringArray("answerList",answerList);
                            //用户的选择，数组
                            bundle.putIntArray("pickList",ShapePracFragment.selectArray);
    ...
    protected void onStop() {
        super.onStop();
        initArray(ShapePracFragment.selectArray);
    }
    ...
    public View getCardView() {
        ...
        //判断题目是否被选中
        //1,获取list
        int arr[] = ShapePracFragment.selectArray;
        //2,遍历数组
    ...
    private void onClick_card(View v) {
        ...
        //初始化布局
        final PopupLayout popupLayout = PopupLayout.init(ShapeExercise.this, parent);
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.btn_submit:  //提交答案
                        Toast.makeText(ShapeExercise.this, "提交", Toast.LENGTH_SHORT).show();
                        //提交答案先检查是否全部答完
                        if (isall()) {  //如果做完
                            //跳转到练习报告页面
                            Intent intent = new Intent(ShapeExercise.this, NumberReport.class);
        ...
        //获取屏幕高度(像素)
        int height = Utils.getScreenHeight(ShapeExercise.this);
        //获取屏幕密度
        float density = Utils.getScreenDensity(ShapeExercise.this);
        //计算屏幕高度（dp）
